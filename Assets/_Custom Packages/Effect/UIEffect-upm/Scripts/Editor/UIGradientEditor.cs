...
namespace Coffee.UIEffects.Editors
{
    ...
    {
        static readonly GUIContent k_TextVerticalOffset = new GUIContent("Vertical Offset");
        static readonly GUIContent k_TextHorizontalOffset = new GUIContent("Horizontal Offset");
        static readonly GUIContent k_TextOffset = new GUIContent("Offset");
        static readonly GUIContent k_TextLeft = new GUIContent("Left");
        static readonly GUIContent k_TextRight = new GUIContent("Right");
        static readonly GUIContent k_TextTop = new GUIContent("Top");
        static readonly GUIContent k_TextBottom = new GUIContent("Bottom");
        static readonly GUIContent k_TextColor1 = new GUIContent("Color 1");
        static readonly GUIContent k_TextColor2 = new GUIContent("Color 2");
        static readonly GUIContent k_TextDiagonalColor = new GUIContent("Diagonal Color");
