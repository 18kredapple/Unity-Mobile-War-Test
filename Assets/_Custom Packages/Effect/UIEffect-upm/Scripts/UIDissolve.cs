...
namespace Coffee.UIEffects
{
    ...
    {
        const uint k_ShaderId = 0 << 3;
        static readonly ParameterTexture s_ParamTex = new ParameterTexture(8, 128, "_ParamTex");
        static readonly int k_TransitionTexId = Shader.PropertyToID("_TransitionTex");

        bool _lastKeepAspectRatio;
        EffectArea _lastEffectArea;
        static Texture _defaultTransitionTexture;
        ...
        static Texture defaultTransitionTexture
        {
            get
            {
