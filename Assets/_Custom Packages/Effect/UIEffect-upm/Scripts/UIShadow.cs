...
namespace Coffee.UIEffects
{
    ...
    public class UIShadow : BaseMeshEffect, IParameterTexture
    {
        ...
        /// </summary>
        public ParameterTexture paramTex { get; set; }
        ...
        /// </summary>
        void ApplyShadow(List<UIVertex> verts, Color color, ref int start, ref int end, Vector2 distance,
        ...
        /// * It is similar to Shadow component implementation.
        /// </summary>
        void ApplyShadowZeroAlloc(List<UIVertex> verts, Color color, ref int start, ref int end, float x,
            float y, bool alpha)
        {
            // Check list capacity.
            var count = end - start;
