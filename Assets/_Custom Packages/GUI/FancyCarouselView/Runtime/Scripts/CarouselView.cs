...
namespace FancyCarouselView.Runtime.Scripts
{
    ...
    {
        const float FlickThreshold = 3.0f;

        [SerializeField] Scroller _scroller;
        [SerializeField] TCell _cellPrefab;
        [SerializeField] Vector2 _cellSize = new Vector2(100, 100);
        [SerializeField] float _cellSpacing = 30.0f;
        [SerializeField] float _snapAnimationDuration = 0.2f;
        [SerializeField] Ease _snapAnimationType = Ease.OutQuad;
        [SerializeField] bool _autoScrollingEnabled;
        [SerializeField] float _autoScrollingIntervalSec = 3.0f;
        [SerializeField] bool _inverseAutoScrollingDirection;
        [SerializeField] CarouselProgressView _progressView;
        [SerializeField] bool _progressViewInteraction;
        int _activeCellIndex = -1;
        Coroutine _autoScrollCoroutine;
        bool _scrollerDraggableCache;
        ...
        int ActiveCellPosition => Mathf.RoundToInt(_scroller.Position);
        ...
        void OnProgressViewElementClicked(int index)
        {
        ...
        IEnumerator ScrollRoutine(float position, float duration, Ease easeType, Action onComplete = null)
        {
        ...
        float GetCircularPosition(float position)
        {
            var size = DataCount;
