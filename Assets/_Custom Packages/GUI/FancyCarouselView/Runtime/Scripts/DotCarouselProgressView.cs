...
namespace FancyCarouselView.Runtime.Scripts
{
    ...
    {
        [SerializeField] DotCarouselProgressElement progressElementPrefab;
        int _activeIndex = -1;

        List<DotCarouselProgressElement> _progressElementInstances = new List<DotCarouselProgressElement>();
