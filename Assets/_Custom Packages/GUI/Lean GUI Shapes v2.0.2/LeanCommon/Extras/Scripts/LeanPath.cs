...
namespace Lean.Common
{
	...
	public class LeanPath : MonoBehaviour
	{
		...
		Vector3 GetPointRaw(int index, int count)
		{
			if (Loop == true)
			{
		...
		Vector3 GetClosestPoint(Vector3 position, Vector3 origin, Vector3 direction)
		{
		...
		Vector3 GetClosestPoint(Ray ray, Vector3 origin, Vector3 direction)
		{
		...
		float GetClosestDistance(Ray ray, Vector3 point)
		{
