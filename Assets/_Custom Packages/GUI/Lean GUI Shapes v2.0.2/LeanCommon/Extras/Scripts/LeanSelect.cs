...
namespace Lean.Common
{
	...
	public class LeanSelect : MonoBehaviour
	{
		...
		public static LinkedList<LeanSelect> Instances = new LinkedList<LeanSelect>(); [System.NonSerialized] LinkedListNode<LeanSelect> instancesNode;
		...
		[SerializeField] bool deselectWithNothing;
		...
		[SerializeField] LimitType limit;
		...
		[SerializeField] int maxSelectables = 5;
		...
		[SerializeField] ReselectType reselect = ReselectType.SelectAgain;
		...
		[SerializeField] LeanSelectableEvent onSelected;
		...
		[SerializeField] LeanSelectableEvent onDeselected;
		...
		[SerializeField] UnityEvent onNothing;
		...
		bool TryReselect(LeanSelectable selectable)
		{
			switch (reselect)
			{
