...
namespace Lean.Common
{
	...
	public class LeanSelectable : MonoBehaviour
	{
		...
		public static LinkedList<LeanSelectable> Instances = new LinkedList<LeanSelectable>(); [System.NonSerialized] LinkedListNode<LeanSelectable> instancesNode;
		...
		[SerializeField] bool selfSelected;
		...
		[SerializeField] LeanSelectEvent onSelected;
		...
		[SerializeField] LeanSelectEvent onDeselected;
...
namespace Lean.Common.Editor
{
	...
	public class LeanSelectable_Editor : CwEditor
	{
		...
		bool IsSelectedByAnyTgt(LeanSelect select)
		{
