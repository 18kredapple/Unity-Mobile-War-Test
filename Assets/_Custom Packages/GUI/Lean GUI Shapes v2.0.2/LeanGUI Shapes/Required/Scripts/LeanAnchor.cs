...
namespace Lean.Gui
{
	...
	public class LeanAnchor
	{
		...
		public Transform Transform { set { transform = value; } get { return transform; } }
		...
		Vector3 GetViewportPoint(Camera camera, Vector3 point)
		{
...
namespace Lean.Gui
{
	...
	public class LeanAnchorDrawer : PropertyDrawer
	{
		...
		void DrawProperty(ref Rect rect, SerializedProperty property, string childName, GUIContent label = null, string overrideName = null, string overrideTooltip = null)
		{
