...
namespace Lean.Gui
{
	...
	public class LeanBox : MaskableGraphic
	{
		...
		public float Blur { set { if (blur != value) { blur = value; SetAllDirty(); } } get { return blur; } }
		[SerializeField] float blur = 0.5f;

		/// <summary>This allows you to set the thickness of the border in local space.</summary>
		public float Thickness { set { if (thickness != value) { thickness = value; SetAllDirty(); } } get { return thickness; } }
		...
		public float Inflate { set { if (inflate != value) { inflate = value; SetAllDirty(); } } get { return inflate; } }
		[SerializeField] float inflate;

		/// <summary>This allows you to set the base detail of the box corners.</summary>
		public float Detail { set { if (detail != value) { detail = value; SetAllDirty(); } } get { return detail; } }
		[SerializeField] float detail = 10.0f;

		/// <summary>This allows you to manually override the detail of the top left corner of this box.
		/// -1 = No Override</summary>
		public float DetailTL { set { if (detailTL != value) { detailTL = value; SetAllDirty(); } } get { return detailTL; } }
		[SerializeField] float detailTL = -1.0f;

		/// <summary>This allows you to manually override the detail of the top right corner of this box.
		/// -1 = No Override</summary>
		public float DetailTR { set { if (detailTR != value) { detailTR = value; SetAllDirty(); } } get { return detailTR; } }
		[SerializeField] float detailTR = -1.0f;

		/// <summary>This allows you to manually override the radius of the bottom left corner of this box.
		/// -1 = No Override</summary>
		public float DetailBL { set { if (detailBL != value) { detailBL = value; SetAllDirty(); } } get { return detailBL; } }
		[SerializeField] float detailBL = -1.0f;

		/// <summary>This allows you to manually override the detail of the bottom right corner of this box.
		/// -1 = No Override</summary>
		public float DetailBR { set { if (detailBR != value) { detailBR = value; SetAllDirty(); } } get { return detailBR; } }
		[SerializeField] float detailBR = -1.0f;

		/// <summary>This allows you to set the base radius of the box corners.</summary>
		public float Radius { set { if (radius != value) { radius = value; SetAllDirty(); } } get { return radius; } }
		[SerializeField] float radius = 5.0f;

		/// <summary>This allows you to manually override the radius of the top left corner of this box.
		/// -1 = No Override</summary>
		public float RadiusTL { set { if (radiusTL != value) { radiusTL = value; SetAllDirty(); } } get { return radiusTL; } }
		[SerializeField] float radiusTL = -1.0f;

		/// <summary>This allows you to manually override the radius of the top right corner of this box.
		/// -1 = No Override</summary>
		public float RadiusTR { set { if (radiusTR != value) { radiusTR = value; SetAllDirty(); } } get { return radiusTR; } }
		[SerializeField] float radiusTR = -1.0f;

		/// <summary>This allows you to manually override the radius of the bottom left corner of this box.
		/// -1 = No Override</summary>
		public float RadiusBL { set { if (radiusBL != value) { radiusBL = value; SetAllDirty(); } } get { return radiusBL; } }
		[SerializeField] float radiusBL = -1.0f;

		/// <summary>This allows you to manually override the radius of the bottom right corner of this box.
		/// -1 = No Override</summary>
		public float RadiusBR { set { if (radiusBR != value) { radiusBR = value; SetAllDirty(); } } get { return radiusBR; } }
		[SerializeField] float radiusBR = -1.0f;

		static UIVertex vert = UIVertex.simpleVert;

		static int pointCount;

		static Corner[] corners = new Corner[] { new Corner(), new Corner(), new Corner(), new Corner() };
		...
		void WriteAll(VertexHelper vh, Rect rect, float offset, bool limit)
		{
		...
		int CalculatePoints(float radius, float detail)
		{
			return Mathf.Max(1, detail >= 0.0f ? (int)detail : (int)this.detail);
		}

		void Shift(float size, ref float radiusA, ref float radiusB)
		{
		...
		void SetCorner(int index, float radius, int points, float ao)
		{
		...
		void WriteTriangleDisc(VertexHelper vh)
		{
		...
		void WriteTriangleRing(VertexHelper vh, int innerO, int outerO)
		{
			var innerA = innerO;
			var outerA = outerO;
...
namespace Lean.Gui.Editor
{
	...
	{
		static bool expandDetail;
		static bool expandRadius;
