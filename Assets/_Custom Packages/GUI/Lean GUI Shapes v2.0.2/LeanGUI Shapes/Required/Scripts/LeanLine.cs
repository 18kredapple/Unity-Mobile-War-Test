...
namespace Lean.Gui
{
	...
	public class LeanLine : MonoBehaviour
	{
		...
		public Camera WorldCamera { set { worldCamera = value; } get { return worldCamera; } }
		[SerializeField] Camera worldCamera;

		/// <summary>The start point of the <b>RectTransform</b> will be placed at this anchor point.</summary>
		public LeanAnchor AnchorA { get { if (anchorA == null) anchorA = new LeanAnchor(); return anchorA; } }
		[SerializeField] LeanAnchor anchorA;

		/// <summary>The end point of the <b>RectTransform</b> will be placed at this anchor point.</summary>
		public LeanAnchor AnchorB { get { if (anchorB == null) anchorB = new LeanAnchor(); return anchorB; } }
		[SerializeField] LeanAnchor anchorB;
		...
		static void SetPosition(RectTransform rectTransform, Vector3 position)
		{
