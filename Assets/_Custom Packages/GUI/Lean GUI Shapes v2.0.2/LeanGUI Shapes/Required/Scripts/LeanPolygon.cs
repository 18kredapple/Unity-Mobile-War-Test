...
namespace Lean.Gui
{
	...
	public class LeanPolygon : MaskableGraphic
	{
		...
		public float Blur { set { blur = value; } get { return blur; } }
		...
		public List<Vector4> Points { get { if (points == null) points = new List<Vector4>(); return points; } }
		[SerializeField] List<Vector4> points;

		static Texture2D blurTexture;

		static bool blurTextureSet;

		static UIVertex vert = UIVertex.simpleVert;

		static List<Vector2> positions = new List<Vector2>();

		static List<Vector2> shiftedPositions = new List<Vector2>();

		static List<Vector2> normals = new List<Vector2>();
		...
		void WriteVertexRing(VertexHelper vh, float distance)
		{
		...
		static Vector2 CalculateNormal(Vector2 vector)
		{
...
namespace Lean.Gui.Editor
{
	...
	public class LeanPolygon_Editor : CwEditor
	{
		...
		static GUIStyle downStyle;

		static Rect cachedRect;
		...
		PresetType preset;
		int presetPoints = 10;
		float presetRadius = 50.0f;
		Vector2 presetCenter;
		Vector2 presetSize = new Vector2(50.0f, 50.0f);
		...
		int GetClosestPoint(ref float foundDistance)
		{
		...
		void DrawPoint(Vector2 localPoint)
		{
		...
		static float GetDistance(Vector2 a, Vector2 b, Vector2 p, ref Vector2 closest)
		{
			var ba = b - a;
		...
		int GetClosestEdge(ref float bestDistance, ref Vector2 bestPoint)
		{
			var localPoint = GetMouseLocalPoint();
			var bestIndex = -1;
		...
		float GetViewScale(float pixels)
		{
