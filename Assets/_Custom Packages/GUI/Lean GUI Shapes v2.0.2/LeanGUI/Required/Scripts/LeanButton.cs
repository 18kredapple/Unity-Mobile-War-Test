...
namespace Lean.Gui
{
	...
	public class LeanButton : LeanSelectable, IPointerDownHandler, IBeginDragHandler, IDragHandler, IEndDragHandler, ISubmitHandler
	{
		...
		[SerializeField] ButtonTypes requiredButtons = (ButtonTypes)~0;
		...
		public bool MultiDown { set { multiDown = value; } get { return multiDown; } }
		[SerializeField] bool multiDown;
		...
		[SerializeField] float dragThreshold = 10.0f;
		...
		public LeanPlayer NormalTransitions { get { if (normalTransitions == null) normalTransitions = new LeanPlayer(); return normalTransitions; } }
		[SerializeField] LeanPlayer normalTransitions;
		...
		public LeanPlayer ClickTransitions { get { if (clickTransitions == null) clickTransitions = new LeanPlayer(); return clickTransitions; } }
		[SerializeField] LeanPlayer clickTransitions;
		...
		public UnityEvent OnClick { get { if (onClick == null) onClick = new UnityEvent(); return onClick; } }
		[SerializeField] UnityEvent onClick;

		[System.NonSerialized] Vector2 totalDelta;

		/// <summary>Track the currently down pointers so we can toggle the transition.</summary>
		List<int> downPointers = new List<int>();
		...
		bool RequiredButtonPressed(PointerEventData eventData)
		{
