...
namespace Lean.Gui
{
	...
	public class LeanConstrainAnchoredPosition : MonoBehaviour
	{
		...
		public float HorizontalPixelMin { set { horizontalPixelMin = value; } get { return horizontalPixelMin; } }
		[SerializeField] float horizontalPixelMin = -100.0f;

		/// <summary>The maximum value in pixels.</summary>
		public float HorizontalPixelMax { set { horizontalPixelMax = value; } get { return horizontalPixelMax; } }
		[SerializeField] float horizontalPixelMax = 100.0f;

		/// <summary>The minimum value in 0..1 percent of the current RectTransform size.</summary>
		public float HorizontalRectMin { set { horizontalRectMin = value; } get { return horizontalRectMin; } }
		[SerializeField] float horizontalRectMin;

		/// <summary>The maximum value in 0..1 percent of the current RectTransform size.</summary>
		public float HorizontalRectMax { set { horizontalRectMax = value; } get { return horizontalRectMax; } }
		[SerializeField] float horizontalRectMax;

		/// <summary>The minimum value in 0..1 percent of the parent RectTransform size.</summary>
		public float HorizontalParentMin { set { horizontalParentMin = value; } get { return horizontalParentMin; } }
		[SerializeField] float horizontalParentMin;

		/// <summary>The maximum value in 0..1 percent of the parent RectTransform size.</summary>
		public float HorizontalParentMax { set { horizontalParentMax = value; } get { return horizontalParentMax; } }
		[SerializeField] float horizontalParentMax;
		...
		/// <summary>The minimum value in pixels.</summary>
		public float VerticalPixelMin { set { verticalPixelMin = value; } get { return verticalPixelMin; } }
		[SerializeField] float verticalPixelMin = -100.0f;

		/// <summary>The maximum value in pixels.</summary>
		public float VerticalPixelMax { set { verticalPixelMax = value; } get { return verticalPixelMax; } }
		[SerializeField] float verticalPixelMax = 100.0f;

		/// <summary>The minimum value in 0..1 percent of the current RectTransform size.</summary>
		public float VerticalRectMin { set { verticalRectMin = value; } get { return verticalRectMin; } }
		[SerializeField] float verticalRectMin;

		/// <summary>The maximum value in 0..1 percent of the current RectTransform size.</summary>
		public float VerticalRectMax { set { verticalRectMax = value; } get { return verticalRectMax; } }
		[SerializeField] float verticalRectMax;

		/// <summary>The minimum value in 0..1 percent of the parent RectTransform size.</summary>
		public float VerticalParentMin { set { verticalParentMin = value; } get { return verticalParentMin; } }
		[SerializeField] float verticalParentMin;

		/// <summary>The maximum value in 0..1 percent of the parent RectTransform size.</summary>
		public float VerticalParentMax { set { verticalParentMax = value; } get { return verticalParentMax; } }
		[SerializeField] float verticalParentMax;
