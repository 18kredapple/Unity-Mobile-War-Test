...
namespace Lean.Gui
{
	...
	public class LeanHover : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
	{
		...
		public bool MultiEnter { set { multiEnter = value; } get { return multiEnter; } }
		[SerializeField] bool multiEnter;
		...
		public bool MultiExit { set { multiExit = value; } get { return multiExit; } }
		[SerializeField] bool multiExit;
		...
		public LeanPlayer EnterTransitions { get { if (enterTransitions == null) enterTransitions = new LeanPlayer(); return enterTransitions; } }
		[SerializeField] LeanPlayer enterTransitions;
		...
		[SerializeField] LeanPlayer exitTransitions;
		...
		List<int> enteredPointers = new List<int>();
