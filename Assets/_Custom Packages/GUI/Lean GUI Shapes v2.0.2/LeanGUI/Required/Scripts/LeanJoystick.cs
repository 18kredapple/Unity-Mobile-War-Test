...
namespace Lean.Gui
{
	...
	public class LeanJoystick : LeanSelectable, IPointerDownHandler, IPointerUpHandler
	{
		...
		public ShapeType Shape { set { shape = value; } get { return shape; } }
		...
		public Vector2 Size { set { size = value; } get { return size; } }
		[SerializeField] Vector2 size = new Vector2(25.0f, 25.0f);
		...
		public RectTransform Handle { set { handle = value; } get { return handle; } }
		...
		public bool SnapWhileHeld { set { snapWhileHeld = value; } get { return snapWhileHeld; } }
		[SerializeField] bool snapWhileHeld = true;
		...
		public bool RelativeToOrigin { set { relativeToOrigin = value; } get { return relativeToOrigin; } }
		[SerializeField] bool relativeToOrigin;
		...
		public bool CenterOnRelease { set { centerOnRelease = value; } get { return centerOnRelease; } }
		[SerializeField] bool centerOnRelease = true;
		...
		public RectTransform RelativeRect { set { relativeRect = value; } get { return relativeRect; } }
		[SerializeField] RectTransform relativeRect;
		...
		public Vector2 ScaledValue { get { return scaledValue; } }
		[SerializeField] Vector2 scaledValue;
		...
		public LeanPlayer DownTransitions { get { if (downTransitions == null) downTransitions = new LeanPlayer(); return downTransitions; } }
		[SerializeField] LeanPlayer downTransitions;
		...
		public LeanPlayer UpTransitions { get { if (upTransitions == null) upTransitions = new LeanPlayer(); return upTransitions; } }
		[SerializeField] LeanPlayer upTransitions;

		/// <summary>This allows you to perform an action when a finger begins touching the joystick.</summary>
		public UnityEvent OnDown { get { if (onDown == null) onDown = new UnityEvent(); return onDown; } }
		[SerializeField] UnityEvent onDown;

		/// <summary>This event is invoked each frame with the ScaledValue.</summary>
		public Vector2Event OnSet { get { if (onSet == null) onSet = new Vector2Event(); return onSet; } }
		[SerializeField] Vector2Event onSet;
