...
namespace Lean.Gui
{
	...
	public class LeanJoystickKey : MonoBehaviour
	{
		...
		/// X = Right.
		/// Y = Up.</summary>
		public Vector2 Delta { set { delta = value; } get { return delta; } }
		[SerializeField] Vector2 delta = new Vector2(0.0f, 10.0f);
		...
		[SerializeField] bool scaleByTime;

		[System.NonSerialized]
		LeanJoystick cachedJoystick;
