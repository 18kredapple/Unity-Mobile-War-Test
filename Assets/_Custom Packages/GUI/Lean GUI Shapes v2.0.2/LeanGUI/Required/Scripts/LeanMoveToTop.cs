...
namespace Lean.Gui
{
	...
	public class LeanMoveToTop : MonoBehaviour, IPointerDownHandler
	{
		...
		public MoveType Move { set { move = value; } get { return move; } }
		[SerializeField] MoveType move;
		...
		static List<LeanMoveToTop> tempOthers = new List<LeanMoveToTop>();
...
namespace Lean.Gui.Editor
{
	...
	public class LeanMoveToTop_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			...
			Draw("movePlayCount", "This allows you to choose which component to perform the action on.\n\nThisTransform = transform.SetAsLastSibling().\n\nTargetTransform = Target.SetAsLastSibling().\n\nParentComponents = Invoke all <b>LeanMoveToTop</b> ancestor components.");
