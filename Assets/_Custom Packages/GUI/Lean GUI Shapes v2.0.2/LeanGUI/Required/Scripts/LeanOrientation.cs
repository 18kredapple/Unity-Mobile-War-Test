...
namespace Lean.Gui
{
	...
	public class LeanOrientation : MonoBehaviour
	{
		...
		public bool AnchoredPosition { set { anchoredPosition = value; dirty = true; } get { return anchoredPosition; } }
		[SerializeField] bool anchoredPosition;

		/// <summary>The RectTransform.anchoredPosition value when in landscape mode.</summary>
		public Vector2 AnchoredPositionL { set { anchoredPositionL = value; dirty = true; } get { return anchoredPositionL; } }
		[SerializeField] Vector2 anchoredPositionL;

		/// <summary>The RectTransform.anchoredPosition value when in portrait mode.</summary>
		public Vector2 AnchoredPositionP { set { anchoredPositionP = value; dirty = true; } get { return anchoredPositionP; } }
		[SerializeField] Vector2 anchoredPositionP;

		/// <summary>Should the RectTransform.sizeDelta setting change based on device orientation?</summary>
		public bool SizeDelta { set { sizeDelta = value; dirty = true; } get { return sizeDelta; } }
		[SerializeField] bool sizeDelta;

		/// <summary>The RectTransform.sizeDelta value when in landscape mode.</summary>
		public Vector2 SizeDeltaL { set { sizeDeltaL = value; dirty = true; } get { return sizeDeltaL; } }
		[SerializeField] Vector2 sizeDeltaL;

		/// <summary>The RectTransform.sizeDelta value when in portrait mode.</summary>
		public Vector2 SizeDeltaP { set { sizeDeltaP = value; dirty = true; } get { return sizeDeltaP; } }
		[SerializeField] Vector2 sizeDeltaP;

		/// <summary>Should the RectTransform.anchorMin setting change based on device orientation?</summary>
		public bool AnchorMin { set { anchorMin = value; dirty = true; } get { return anchorMin; } }
		[SerializeField] bool anchorMin;

		/// <summary>The RectTransform.anchorMin value when in landscape mode.</summary>
		public Vector2 AnchorMinL { set { anchorMinL = value; dirty = true; } get { return anchorMinL; } }
		[SerializeField] Vector2 anchorMinL;

		/// <summary>The RectTransform.anchorMin value when in portrait mode.</summary>
		public Vector2 AnchorMinP { set { anchorMinP = value; dirty = true; } get { return anchorMinP; } }
		[SerializeField] Vector2 anchorMinP;

		/// <summary>Should the RectTransform.anchorMax setting change based on device orientation?</summary>
		public bool AnchorMax { set { anchorMax = value; dirty = true; } get { return anchorMax; } }
		[SerializeField] bool anchorMax;

		/// <summary>The RectTransform.anchorMax value when in landscape mode.</summary>
		public Vector2 AnchorMaxL { set { anchorMaxL = value; dirty = true; } get { return anchorMaxL; } }
		[SerializeField] Vector2 anchorMaxL;

		/// <summary>The RectTransform.anchorMax value when in portrait mode.</summary>
		public Vector2 AnchorMaxP { set { anchorMaxP = value; dirty = true; } get { return anchorMaxP; } }
		[SerializeField] Vector2 anchorMaxP;

		/// <summary>Should the RectTransform.offsetMin setting change based on device orientation?</summary>
		public bool OffsetMin { set { offsetMin = value; dirty = true; } get { return offsetMin; } }
		[SerializeField] bool offsetMin;

		/// <summary>The RectTransform.offsetMin value when in landscape mode.</summary>
		public Vector2 OffsetMinL { set { offsetMinL = value; dirty = true; } get { return offsetMinL; } }
		[SerializeField] Vector2 offsetMinL;

		/// <summary>The RectTransform.offsetMin value when in portrait mode.</summary>
		public Vector2 OffsetMinP { set { offsetMinP = value; dirty = true; } get { return offsetMinP; } }
		[SerializeField] Vector2 offsetMinP;

		/// <summary>Should the RectTransform.offsetMax setting change based on device orientation?</summary>
		public bool OffsetMax { set { offsetMax = value; dirty = true; } get { return offsetMax; } }
		[SerializeField] bool offsetMax;

		/// <summary>The RectTransform.offsetMax value when in landscape mode.</summary>
		public Vector2 OffsetMaxL { set { offsetMaxL = value; dirty = true; } get { return offsetMaxL; } }
		[SerializeField] Vector2 offsetMaxL;

		/// <summary>The RectTransform.offsetMax value when in portrait mode.</summary>
		public Vector2 OffsetMaxP { set { offsetMaxP = value; dirty = true; } get { return offsetMaxP; } }
		[SerializeField] Vector2 offsetMaxP;

		/// <summary>Should the RectTransform.pivot setting change based on device orientation?</summary>
		public bool Pivot { set { pivot = value; dirty = true; } get { return pivot; } }
		[SerializeField] bool pivot;

		/// <summary>The RectTransform.pivot value when in landscape mode.</summary>
		public Vector2 PivotL { set { pivotL = value; dirty = true; } get { return pivotL; } }
		[SerializeField] Vector2 pivotL;

		/// <summary>The RectTransform.pivot value when in portrait mode.</summary>
		public Vector2 PivotP { set { pivotP = value; dirty = true; } get { return pivotP; } }
		[SerializeField] Vector2 pivotP;

		/// <summary>Should the RectTransform.localRotation setting change based on device orientation?</summary>
		public bool LocalRotation { set { localRotation = value; dirty = true; } get { return localRotation; } }
		[SerializeField] bool localRotation;

		/// <summary>The RectTransform.localRotation value when in landscape mode.</summary>
		public Quaternion LocalRotationL { set { localRotationL = value; dirty = true; } get { return localRotationL; } }
		[SerializeField] Quaternion localRotationL = Quaternion.identity;

		/// <summary>The RectTransform.localRotation value when in portrait mode.</summary>
		public Quaternion LocalRotationP { set { localRotationP = value; dirty = true; } get { return localRotationP; } }
		[SerializeField] Quaternion localRotationP = Quaternion.identity;

		/// <summary>Should the RectTransform.localScale setting change based on device orientation?</summary>
		public bool LocalScale { set { localScale = value; dirty = true; } get { return localScale; } }
		[SerializeField] bool localScale;

		/// <summary>The RectTransform.localScale value when in landscape mode.</summary>
		public Vector3 LocalScaleL { set { localScaleL = value; dirty = true; } get { return localScaleL; } }
		[SerializeField] Vector3 localScaleL;

		/// <summary>The RectTransform.localScale value when in portrait mode.</summary>
		public Vector3 LocalScaleP { set { localScaleP = value; dirty = true; } get { return localScaleP; } }
		[SerializeField] Vector3 localScaleP;
		...
		public LeanPlayer LandscapeTransitions { get { if (landscapeTransitions == null) landscapeTransitions = new LeanPlayer(); return landscapeTransitions; } }
		[SerializeField] LeanPlayer landscapeTransitions;
		...
		public LeanPlayer PortraitTransitions { get { if (portraitTransitions == null) portraitTransitions = new LeanPlayer(); return portraitTransitions; } }
		[SerializeField] LeanPlayer portraitTransitions;

		/// <summary>This event will be invoked when the orientation changes to landscape.</summary>
		public UnityEvent OnLandscape { get { if (onLandscape == null) onLandscape = new UnityEvent(); return onLandscape; } }
		[SerializeField] UnityEvent onLandscape;

		/// <summary>This event will be invoked when the orientation changes to portrait.</summary>
		public UnityEvent OnPortrait { get { if (onPortrait == null) onPortrait = new UnityEvent(); return onPortrait; } }
		[SerializeField] UnityEvent onPortrait;
		...
		void UpdateCachedRectTransform()
		{
