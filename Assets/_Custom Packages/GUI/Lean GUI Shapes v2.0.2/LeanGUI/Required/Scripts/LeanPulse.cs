...
namespace Lean.Gui
{
	...
	public class LeanPulse : MonoBehaviour
	{
		...
		/// -1 = unlimited</summary>
		public int RemainingPulses { set { remainingPulses = value; } get { return remainingPulses; } }
		[SerializeField] int remainingPulses = -1;

		/// <summary>When this reaches 0, and RemainingPulses is not 0, this component will pulse.</summary>
		public float RemainingTime { set { remainingTime = value; } get { return remainingTime; } }
		[SerializeField] float remainingTime;

		/// <summary>This allows you to control the amount of seconds between each pulse.
		/// -1 = Manual Pulses Only</summary>
		public float TimeInterval { set { timeInterval = value; } get { return timeInterval; } }
		...
		public LeanTiming Timing { set { timing = value; } get { return timing; } }
		[SerializeField] LeanTiming timing;
		...
		public LeanPlayer PulseTransitions { get { if (pulseTransitions == null) pulseTransitions = new LeanPlayer(); return pulseTransitions; } }
		[SerializeField] LeanPlayer pulseTransitions;

		/// <summary>This allows you to perform an action when this UI element pulses.
		/// int = RemainingPulses</summary>
		public IntEvent OnPulse { get { if (onPulse == null) onPulse = new IntEvent(); return onPulse; } }
		[SerializeField] IntEvent onPulse;

		[System.NonSerialized]
		LinkedListNode<LeanPulse> link;
