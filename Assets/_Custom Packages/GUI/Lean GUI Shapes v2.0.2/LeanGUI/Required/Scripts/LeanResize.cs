...
namespace Lean.Gui
{
	...
	public class LeanResize : LeanSelectable, IBeginDragHandler, IDragHandler, IEndDragHandler
	{
		...
		/// -1 = inverted
		/// 2 = centered</summary>
		public float HorizontalScale { set { horizontalScale = value; } get { return horizontalScale; } }
		[SerializeField] float horizontalScale = 1.0f;
		...
		/// -1 = inverted
		/// 2 = centered</summary>
		public float VerticalScale { set { verticalScale = value; } get { return verticalScale; } }
		[SerializeField] float verticalScale = 1.0f;
		...
		[SerializeField] LeanPlayer beginTransitions;
		...
		[SerializeField] LeanPlayer endTransitions;
		...
		void DraggingCheck(ref bool check)
		{
			if (dragging == true)
			{
				check = true;
