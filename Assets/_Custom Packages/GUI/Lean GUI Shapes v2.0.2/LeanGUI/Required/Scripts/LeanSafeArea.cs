...
namespace Lean.Gui
{
	...
	public class LeanSafeArea : UIBehaviour
	{
		...
		[Range(0.0f, 1.0f)][SerializeField] Vector2 horizontalRange = new Vector2(0.0f, 1.0f);
		...
		[Range(0.0f, 1.0f)][SerializeField] Vector2 verticalRange = new Vector2(0.0f, 1.0f);
