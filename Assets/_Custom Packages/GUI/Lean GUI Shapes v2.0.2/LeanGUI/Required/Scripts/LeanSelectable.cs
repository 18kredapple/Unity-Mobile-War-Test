...
namespace Lean.Gui
{
	...
	public abstract class LeanSelectable : Selectable
	{
		...
		public LeanPlayer InteractableTransitions { get { if (interactableTransitions == null) interactableTransitions = new LeanPlayer(); return interactableTransitions; } }
		[SerializeField] LeanPlayer interactableTransitions;

		/// <summary>This allows you to perform a transition when this element becomes non-interactable.
		/// You can create a new transition GameObject by right clicking the transition name, and selecting <b>Create</b>.
		/// For example, the <b>Graphic.color Transition (LeanGraphicColor)</b> component can be used to change the color.
		/// NOTE: Any transitions you perform here must be reverted in the <b>Landscape Transitions</b> setting using a matching transition component.</summary>
		public LeanPlayer NonInteractableTransitions { get { if (nonInteractableTransitions == null) nonInteractableTransitions = new LeanPlayer(); return nonInteractableTransitions; } }
		[SerializeField] LeanPlayer nonInteractableTransitions;

		public UnityEvent OnInteractable { get { if (onInteractable == null) onInteractable = new UnityEvent(); return onInteractable; } }
		[SerializeField] UnityEvent onInteractable;

		public UnityEvent OnNonInteractable { get { if (onNonInteractable == null) onNonInteractable = new UnityEvent(); return onNonInteractable; } }
		[SerializeField] UnityEvent onNonInteractable;

		[SerializeField]
		bool expectedInteractable = true;
