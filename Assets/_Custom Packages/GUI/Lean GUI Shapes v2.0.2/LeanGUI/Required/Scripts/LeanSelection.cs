...
namespace Lean.Gui
{
	...
	public class LeanSelection : MonoBehaviour
	{
		...
		public LeanPlayer SelectTransitions { get { if (selectTransitions == null) selectTransitions = new LeanPlayer(); return selectTransitions; } }
		[SerializeField] LeanPlayer selectTransitions;
		...
		public LeanPlayer DeselectTransitions { get { if (deselectTransitions == null) deselectTransitions = new LeanPlayer(); return deselectTransitions; } }
		[SerializeField] LeanPlayer deselectTransitions;
