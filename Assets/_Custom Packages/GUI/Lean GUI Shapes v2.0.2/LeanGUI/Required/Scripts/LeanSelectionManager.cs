...
namespace Lean.Gui
{
	...
	public class LeanSelectionManager : MonoBehaviour
	{
		...
		public bool ForceSelection { set { forceSelection = value; } get { return forceSelection; } }
		[SerializeField] bool forceSelection;
		...
		public List<Selectable> SelectionHistory { get { if (selectionHistory == null) selectionHistory = new List<Selectable>(); return selectionHistory; } }
		[SerializeField] List<Selectable> selectionHistory;

		static List<Selectable> tempSelectables = new List<Selectable>();

#if UNITY_2019_1_OR_NEWER
		static Selectable[] tempSelectablesArray = new Selectable[1024];
#endif
