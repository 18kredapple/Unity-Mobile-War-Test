...
namespace Lean.Gui
{
	...
	public class LeanShake : MonoBehaviour
	{
		...
		[SerializeField] Vector3 shakePosition = new Vector3(1.0f, 1.0f, 0.0f);
		...
		[SerializeField] Vector3 shakeRotation = new Vector3(0.0f, 0.0f, 1.0f);
		...
		float Sample(ref float x, float prime)
		{
