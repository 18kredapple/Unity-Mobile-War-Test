...
namespace Lean.Gui
{
	...
	public class LeanSizer : UIBehaviour
	{
		...
		public RectTransform Target { set { if (target != value) { target = value; UpdateSize(); } } get { return target; } }
		[SerializeField] RectTransform target;

		/// <summary>Factor in scale when reading the size of the target?</summary>
		public bool Scale { set { if (scale != value) { scale = value; UpdateSize(); } } get { return scale; } }
		[SerializeField] bool scale;

		/// <summary>Match the scale horizontally?</summary>
		public bool Horizontal { set { if (horizontal != value) { horizontal = value; UpdateSize(); } } get { return horizontal; } }
		[SerializeField] bool horizontal;

		public float HorizontalPadding { set { if (horizontalPadding != value) { horizontalPadding = value; UpdateSize(); } } get { return horizontalPadding; } }
		[SerializeField] float horizontalPadding;

		/// <summary>Match the scale vertically?</summary>
		public bool Vertical { set { if (vertical != value) { vertical = value; UpdateSize(); } } get { return vertical; } }
		[SerializeField] bool vertical;

		public float VerticalPadding { set { if (verticalPadding != value) { verticalPadding = value; UpdateSize(); } } get { return verticalPadding; } }
