...
namespace Lean.Gui
{
	...
	public class LeanSnap : MonoBehaviour
	{
		...
		public float HorizontalOffset { set { horizontalOffset = value; } get { return horizontalOffset; } }
		[SerializeField] float horizontalOffset;

		/// <summary>The spacing between each snap point in pixels.</summary>
		public float HorizontalIntervalPixel { set { horizontalIntervalPixel = value; } get { return horizontalIntervalPixel; } }
		[SerializeField] float horizontalIntervalPixel = 10.0f;
		...
		[SerializeField] float horizontalIntervalRect;

		/// <summary>The spacing between each snap point in 0..1 percent of the parent.</summary>
		public float HorizontalIntervalParent { set { horizontalIntervalParent = value; } get { return horizontalIntervalParent; } }
		[SerializeField] float horizontalIntervalParent;

		/// <summary>The snap speed.
		/// -1 = Instant.
		/// 1 = Slow.
		/// 10 = Fast.</summary>
		public float HorizontalSpeed { set { horizontalSpeed = value; } get { return horizontalSpeed; } }
		...
		/// <summary>The snap points will be offset by this many pixels.</summary>
		public float VerticalOffset { set { verticalOffset = value; } get { return verticalOffset; } }
		[SerializeField] float verticalOffset;

		/// <summary>The spacing between each snap point in pixels.</summary>
		public float VerticalIntervalPixel { set { verticalIntervalPixel = value; } get { return verticalIntervalPixel; } }
		[SerializeField] float verticalIntervalPixel = 10.0f;

		/// <summary>The spacing between each snap point in 0..1 percent of the current RectTransform size.</summary>
		public float VerticalIntervalRect { set { verticalIntervalRect = value; } get { return verticalIntervalRect; } }
		[SerializeField] float verticalIntervalRect;

		/// <summary>The spacing between each snap point in 0..1 percent of the parent.</summary>
		public float VerticalIntervalParent { set { verticalIntervalParent = value; } get { return verticalIntervalParent; } }
		[SerializeField] float verticalIntervalParent;

		/// <summary>The snap speed.
		/// -1 = Instant.
		/// 1 = Slow.
		/// 10 = Fast.</summary>
		public float VerticalSpeed { set { verticalSpeed = value; } get { return verticalSpeed; } }
		...
		public LeanDrag DisableWith { set { disableWith = value; } get { return disableWith; } }
		[SerializeField] LeanDrag disableWith;
		...
		public Vector2IntEvent OnPositionChanged { get { if (onPositionChanged == null) onPositionChanged = new Vector2IntEvent(); return onPositionChanged; } }
		[SerializeField] Vector2IntEvent onPositionChanged;
