...
namespace Lean.Gui
{
	...
	public class LeanSnapEvent : MonoBehaviour
	{
		...
		public Vector2Int Position { set { position = value; } get { return position; } }
		[SerializeField] Vector2Int position;

		/// <summary>The action that will be invoked.</summary>
		public UnityEvent OnAction { get { if (onAction == null) onAction = new UnityEvent(); return onAction; } }
