...
namespace Lean.Gui
{
	...
	public class LeanSwipe : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
	{
		...
		public float MinimumDistance { set { minimumDistance = value; } get { return minimumDistance; } }
		[SerializeField] float minimumDistance = 100.0f;

		/// <summary>The swiping finger must move MinimumDistance within this amount of seconds.</summary>
		public float MaximumTime { set { maximumTime = value; } get { return maximumTime; } }
		[SerializeField] float maximumTime = 0.125f;

		/// <summary>If you need the swipe to be in a specific direction, then enable this.</summary>
		public bool CheckAngle { set { checkAngle = value; } get { return checkAngle; } }
		...
		public float MaximumRange { set { maximumRange = value; } get { return maximumRange; } }
		[Range(0.0f, 360.0f)][SerializeField] float maximumRange = 90.0f;
		...
		public LeanPlayer SwipeTransitions { get { if (swipeTransitions == null) swipeTransitions = new LeanPlayer(); return swipeTransitions; } }
		[SerializeField] LeanPlayer swipeTransitions;

		/// <summary>This allows you to perform an action when you swipe this UI element.</summary>
		public UnityEvent OnSwipe { get { if (onSwipe == null) onSwipe = new UnityEvent(); return onSwipe; } }
		[SerializeField] UnityEvent onSwipe;
