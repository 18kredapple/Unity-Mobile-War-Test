...
namespace Lean.Gui
{
	...
	public class LeanSwitch : MonoBehaviour
	{
		...
		public int State { set { Switch(value); } get { return state; } }
		...
		public List<LeanPlayer> States { get { if (states == null) states = new List<LeanPlayer>(); return states; } }
		[SerializeField] List<LeanPlayer> states;
		...
		public LeanPlayer ChangedStateTransitions { get { if (changedStateTransitions == null) changedStateTransitions = new LeanPlayer(); return changedStateTransitions; } }
		[SerializeField] LeanPlayer changedStateTransitions;

		/// <summary>This allows you to perform an action when this switch changes to a different state.</summary>
		public IntUnityEvent OnChangedState { get { if (onChangedState == null) onChangedState = new IntUnityEvent(); return onChangedState; } }
		[SerializeField] IntUnityEvent onChangedState;

		[System.NonSerialized]
		LinkedListNode<LeanSwitch> link;
...
namespace Lean.Gui.Editor
{
	...
	{
		void DrawState(TARGET tgt, TARGET[] tgts)
		{
			var state = tgt.State;
