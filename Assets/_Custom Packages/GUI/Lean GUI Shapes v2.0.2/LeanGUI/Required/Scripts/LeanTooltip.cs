...
namespace Lean.Gui
{
	...
	public class LeanTooltip : MonoBehaviour
	{
		...
		[SerializeField] ActivationType activation;
		...
		[SerializeField] UnityEventString onShow;
...
namespace Lean.Gui.Editor
{
	...
	public class LeanTooltip_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			...
			Draw("movePlayCount", "Move the attached Transform when the tooltip is open?");
