...
namespace Lean.Gui
{
	...
	public class LeanWindowCloser : MonoBehaviour
	{
		...
		public LeanWindow EmptyWindow { set { emptyWindow = value; } get { return emptyWindow; } }
		[SerializeField] LeanWindow emptyWindow;

		/// <summary>This stores a list of all opened windows, in order of opening, so they can be closed in reverse order.</summary>
		public List<LeanWindow> WindowOrder { get { if (windowOrder == null) windowOrder = new List<LeanWindow>(); return windowOrder; } }
		[SerializeField] List<LeanWindow> windowOrder;
		...
		void RegisterNow(LeanWindow window)
		{
