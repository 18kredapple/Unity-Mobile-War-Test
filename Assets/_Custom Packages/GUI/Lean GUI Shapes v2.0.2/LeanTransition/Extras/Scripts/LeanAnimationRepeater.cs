...
namespace Lean.Transition
{
	...
	public class LeanAnimationRepeater : LeanManualAnimation
	{
		...
		/// -1 = Unlimited.</summary>
		public int RemainingCount { set { remainingCount = value; } get { return remainingCount; } }
		...
		public UnityEvent OnAnimation { get { if (onAnimation == null) onAnimation = new UnityEvent(); return onAnimation; } }
