...
namespace Lean.Transition
{
	...
	public class LeanManualAnimation : MonoBehaviour
	{
		...
		[SerializeField][UnityEngine.Serialization.FormerlySerializedAs("Transitions")] LeanPlayer transitions;

		[System.NonSerialized]
		HashSet<LeanState> states = new HashSet<LeanState>();
		...
		void HandleRegistered(LeanState state)
		{
			states.Add(state);
		}

		void HandleFinished(LeanState state)
		{
			states.Remove(state);
		}
	}
