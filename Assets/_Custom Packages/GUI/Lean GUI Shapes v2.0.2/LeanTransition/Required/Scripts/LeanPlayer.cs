...
namespace Lean.Transition
{
	...
	public class LeanPlayer
	{
		...
		public class Entry
		{
			public Transform Root { set { root = value; } get { return root; } }
			[SerializeField] Transform root;

			public float Speed { set { speed = value; } get { return speed; } }
			[SerializeField] float speed = -1.0f;

			public List<Alias> Aliases { get { if (aliases == null) aliases = new List<Alias>(); return aliases; } }
			[SerializeField] List<Alias> aliases;
		...
		static Dictionary<string, Alias> tempAliases = new Dictionary<string, Alias>();
...
namespace Lean.Transition.Editor
{
	...
	public class LeanPlayerDrawer : PropertyDrawer
	{
		...
		void DrawPlay(Rect position, SerializedObject sObject)
		{
		...
		void ShowMenu(SerializedObject sObject, SerializedProperty sEntries, int index, SerializedProperty sRoot, SerializedProperty sSpeed, string title)
		{
		...
		void ValidateAndUpdate(SerializedObject sObject, SerializedProperty sPlayer)
		{
			sObject.ApplyModifiedProperties();
