...
namespace CW.Common
{
	...
	public class CwLightIntensity : MonoBehaviour
	{
		...
		[SerializeField] float intensityInStandard = 1.0f;
		...
		[SerializeField] float intensityInURP = 1.0f;
		...
		[SerializeField] float intensityInHDRP = 120000.0f;
...
#if __HDRP__
		[System.NonSerialized]
		UnityEngine.Rendering.HighDefinition.HDAdditionalLightData cachedLightData;
#endif
