...
namespace CW.Common
{
	...
	public class CwRenderTextureManager : MonoBehaviour
	{
		...
		static LinkedList<CwRenderTextureManager> instances = new LinkedList<CwRenderTextureManager>();

		LinkedListNode<CwRenderTextureManager> node;
		...
		static bool Match(ref RenderTextureDescriptor a, ref RenderTextureDescriptor b)
		{
