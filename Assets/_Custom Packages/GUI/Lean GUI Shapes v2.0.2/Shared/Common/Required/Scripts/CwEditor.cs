...
namespace CW.Common
{
	...
	{
		static Stack<object> datas = new Stack<object>();

		static GUIContent customContent = new GUIContent();

		static List<Color> colors = new List<Color>();

		static List<float> labelWidths = new List<float>();

		static List<bool> mixedValues = new List<bool>();
		...
		static SerializedProperty GetPropertyAndSetCustomContent(string propertyPath, string overrideTooltip, string overrideText)
		{
