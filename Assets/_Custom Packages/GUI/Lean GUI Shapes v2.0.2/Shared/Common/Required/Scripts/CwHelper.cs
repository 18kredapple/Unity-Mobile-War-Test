...
namespace CW.Common
{
	...
	{
		static Stack<Random.State> seedStates = new Stack<Random.State>();
		...
		static Stack<RenderTexture> actives = new Stack<RenderTexture>();

		static int uniqueSeed;

		static Mesh quadMesh;
		static bool quadMeshSet;
...
namespace CW.Common
{
	...
	public static partial class CwHelper
	{
		static Material cachedShapeOutline;

		static readonly int _CW_ShapeTex = Shader.PropertyToID("_CW_ShapeTex");
		static readonly int _CW_ShapeCoords = Shader.PropertyToID("_CW_ShapeCoords");
		static readonly int _CW_ShapeChannel = Shader.PropertyToID("_CW_ShapeChannel");
		static readonly int _CW_ShapeColor = Shader.PropertyToID("_CW_ShapeColor");
