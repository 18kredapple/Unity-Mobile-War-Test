...
namespace CW.Common
{
	...
	public static class CwInput
	{
		...
		static System.Collections.Generic.Dictionary<KeyCode, NewCode> keyMapping = new System.Collections.Generic.Dictionary<KeyCode, NewCode>()
		{
		...
		static UnityEngine.InputSystem.Controls.ButtonControl GetMouseButtonControl(int index)
		{
		...
		static UnityEngine.InputSystem.Controls.ButtonControl GetButtonControl(KeyCode oldKey)
		{
			if (UnityEngine.InputSystem.Mouse.current != null)
			{
				switch (oldKey)
