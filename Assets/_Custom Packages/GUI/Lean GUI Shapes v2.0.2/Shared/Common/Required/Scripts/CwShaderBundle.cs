...
namespace CW.Common
{
	...
	public class CwShaderBundle : ScriptableObject
	{
		...
		[SerializeField] int variantHash;
		...
		[SerializeField] int projectHash;
		...
		[SerializeField] List<ShaderVariant> variants;
		...
		static Pipeline lastAutoSetPipe = Pipeline.Invalid;
#endif
		...
		static void RegisterAutoSwitch()
		{
		...
		static void ForceSwitch(string name)
		{
		...
		void CompileVariant(Pipeline pipe, JBooth.BetterShaders.OptionOverrides overrides, string path)
		{
		...
		void CompileVariant(JBooth.BetterShaders.OptionOverrides overrides, string path, ShaderVariant variant)
		{
	...
	public class CwShaderBundleDetector : AssetPostprocessor
	{
		...
		void TryCompileFast(string end)
		{
