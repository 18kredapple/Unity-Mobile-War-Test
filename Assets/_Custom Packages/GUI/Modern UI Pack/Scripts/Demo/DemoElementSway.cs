...
namespace Michsky.MUIP
{
    ...
    {
        [Header("Resources")]
        [SerializeField] DemoElementSwayParent swayParent;
        [SerializeField] Canvas mainCanvas;
        [SerializeField] RectTransform swayObject;
        [SerializeField] CanvasGroup normalCG;
        [SerializeField] CanvasGroup highlightedCG;
        [SerializeField] CanvasGroup selectedCG;

        [Header("Settings")]
        [SerializeField] float smoothness = 10;
        [SerializeField] float transitionSpeed = 8;
        [SerializeField][Range(0, 1)] float dissolveAlpha = 0.5f;
