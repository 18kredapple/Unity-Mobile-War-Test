...
namespace Michsky.MUIP
{
    ...
    {
        GUISkin customSkin;
        IconManager imTarget;
        int currentTab;
        int tempSizeIndex;
        string tempSizeID;
        string searchText;
        string defaultSize = "128x";
        ...
        static int SortByNameAtoZ(IconLibrary.IconItem o1, IconLibrary.IconItem o2)
        {
            // Compare the names and sort by A to Z
            return o1.iconTitle.CompareTo(o2.iconTitle);
        }

        static int SortByNameZtoA(IconLibrary.IconItem o1, IconLibrary.IconItem o2)
        {
