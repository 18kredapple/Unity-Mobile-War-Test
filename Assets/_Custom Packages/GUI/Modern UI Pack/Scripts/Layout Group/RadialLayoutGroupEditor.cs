...
namespace Michsky.MUIP
{
    ...
    {
        GUISkin customSkin;
        RadialLayoutGroup rlgTarget;
        int currentTab;

        SerializedProperty layoutDir;
        SerializedProperty radiusStart;
        SerializedProperty radiusRange;
        SerializedProperty angleStart;
        SerializedProperty angleCenter;
        SerializedProperty angleRange;
        SerializedProperty childRotate;
