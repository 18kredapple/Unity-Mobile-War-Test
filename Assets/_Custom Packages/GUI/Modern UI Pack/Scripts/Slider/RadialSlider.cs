...
namespace Michsky.MUIP
{
    ...
    {
        const string PREFS_UI_SAVE_NAME = "Radial";
        ...
        bool isPointerDown;
        float currentAngle;
        float currentAngleOnPointerDown;
        float valueDisplayPrecision;
        ...
        void HandleSliderMouseInput(PointerEventData eventData, bool allowValueWrap)
        {
            if (!isPointerDown)
                return;
