...
namespace AssetKits.ParticleImage.Editor
{
    ...
    public class ParticleImageEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty _timeScale;
        SerializedProperty _playMode;
        SerializedProperty _loop;
        SerializedProperty _prewarm;
        SerializedProperty _duration;
        SerializedProperty _delay;
        SerializedProperty _life;
        SerializedProperty _speed;
        SerializedProperty _startSize;
        SerializedProperty _startRotation;
        SerializedProperty _startColor;
        SerializedProperty _raycast;
        SerializedProperty _maskable;

        //Emitter Properties
        SerializedProperty _rate;
        SerializedProperty _rateOverLifetime;
        SerializedProperty _rateOverDistance;
        SerializedProperty _burst;
        SerializedProperty _emitterShape;
        ...
        SerializedProperty _edge;
        SerializedProperty _spreadType;
        SerializedProperty _spreadLoop;
        SerializedProperty _startPoint;
        SerializedProperty _startPointTrans;

        //Particle Properties
        SerializedProperty _sprite;
        SerializedProperty _texture;
        SerializedProperty _material;
        SerializedProperty _speedOverLifetime;
        SerializedProperty _sizeOverLifetime;
        SerializedProperty _sizeBySpeed;
        SerializedProperty _sizeSpeedRange;
        SerializedProperty _colorOverLifetime;
        SerializedProperty _colorBySpeed;
        SerializedProperty _colorSpeedRange;
        SerializedProperty _rotateOverLifetime;
        SerializedProperty _rotationBySpeed;
        SerializedProperty _rotationSpeedRange;
        SerializedProperty _alignDirection;
        SerializedProperty _sheetModule;
        SerializedProperty _sheetType;
        SerializedProperty _tile;
        SerializedProperty _frameOverTime;
        SerializedProperty _startFrame;
        SerializedProperty _frameSpeedRange;
        SerializedProperty _frameFps;
        SerializedProperty _cycles;

        SerializedProperty _trailModule;
        SerializedProperty _trailWidth;
        SerializedProperty _trailColorOverLifetime;
        SerializedProperty _trailColorOverTrail;
        SerializedProperty _trailMaterial;
        SerializedProperty _trailLifetime;
        SerializedProperty _inheritColor;
        SerializedProperty _dieWithParticle;
        SerializedProperty _trailRatio;
        SerializedProperty _minimumVertexDistance;

        //Movement Properties
        SerializedProperty _targetModule;
        SerializedProperty _targetTransform;
        SerializedProperty _targetCurve;
        SerializedProperty _targetMode;

        SerializedProperty _noiseModule;
        SerializedProperty _noiseFreq;
        SerializedProperty _noiseOffset;
        SerializedProperty _noiseStrength;

        SerializedProperty _velocityModule;
        SerializedProperty _velocitySpace;
        SerializedProperty _velocityOverLifetime;

        SerializedProperty _gravityModule;
        SerializedProperty _gravity;

        SerializedProperty _vortexModule;
        SerializedProperty _vortexStrength;

        //Event Properties
        SerializedProperty _onStart;
        SerializedProperty _onFinish;
        SerializedProperty _onFirstParticleFinish;
        SerializedProperty _onLastParticleFinish;
        SerializedProperty _onParticleFinish;

        //Advanced Properties
        SerializedProperty _multithreadModule;
        SerializedProperty _multithreadEnabled;
        bool hasCollections;
        bool hasMathematics;
        bool hasBurst;

        //Editor Icons
        Texture _particleModuleIcon;
        Texture _movementModuleIcon;
        Texture _emitterModuleIcon;
        Texture _eventModuleIcon;
        Texture _advancedModuleIcon;
        ...
        Vector3 PointInCircle(float angle)
        {
        ...
        bool Foldout(string title, bool display, Texture icon)
        {
