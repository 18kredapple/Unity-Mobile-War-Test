...
namespace AssetKits.ParticleImage
{
    ...
    {
        ParticleImage _source;
        Transform _transform;

        Vector2 _modifiedPosition;
        Vector2 _position;
        ...
        float _colorLerp;
        float _rotateLerp;
        float _attractorLerp;
        float _gravityLerp;
        float _vortexLerp;
        float _frameOverTimeLerp;
        float _velocityLerp;
        float _speedLerp;
        float _startFrameLerp;
        float _ratioRandom;
        Vector2 _attractorTargetPoint;
        ...
        Vector2 _trailLastPos;
        Vector2 _trailDeltaPos;
        bool _hasTrail;
        ...
        List<TrailPoint> _trailPoints = new List<TrailPoint>(128);
        ...
        Vector2[] _rotations = new Vector2[4];

        Vector2 lastTrailPoint;
        ...
        void RotatePointsAroundCenter(Vector2[] points, Vector3 angles)
        {
        ...
        Vector2 RotatePointAroundCenter(Vector2 point, Vector3 angles)
        {
