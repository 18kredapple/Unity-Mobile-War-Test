...
namespace AssetKits.ParticleImage
{
    ...
    public sealed class ParticleImage : MaskableGraphic
    {
        ...
        Mesh.MeshDataArray _trailMeshDataArray;
        Mesh.MeshData _trailMeshData;

        [SerializeField]
        Simulation _space = Simulation.Local;
        ...
        [SerializeField]
        TimeScale _timeScale = TimeScale.Normal;
        ...
        [SerializeField]
        Module _emitterConstraintEnabled = new Module(false);
        ...
        [SerializeField]
        Transform _emitterConstraintTransform;
        ...
        [SerializeField]
        EmitterShape _shape = EmitterShape.Circle;
        /// <summary>
        ...
        [SerializeField]
        SpreadType _spread = SpreadType.Random;
        ...
        [SerializeField]
        PlayMode _playMode = PlayMode.OnAwake;
        ...
        [SerializeField]
        SeparatedMinMaxCurve _startSize = new SeparatedMinMaxCurve(40f);
        ...
        [SerializeField]
        ParticleSystem.MinMaxGradient _startColor = new ParticleSystem.MinMaxGradient(Color.white);
        ...
        [SerializeField]
        ParticleSystem.MinMaxCurve _lifetime = new ParticleSystem.MinMaxCurve(1f);
        ...
        [SerializeField]
        ParticleSystem.MinMaxCurve _startSpeed = new ParticleSystem.MinMaxCurve(2f);
        ...
        [SerializeField]
        ParticleSystem.MinMaxGradient _colorOverLifetime = new ParticleSystem.MinMaxGradient(new Gradient());
        ...
        [SerializeField]
        ParticleSystem.MinMaxGradient _colorBySpeed = new ParticleSystem.MinMaxGradient(new Gradient());
        ...
        [SerializeField]
        SpeedRange _colorSpeedRange = new SpeedRange(0f, 1f);
        ...
        [SerializeField]
        SeparatedMinMaxCurve _sizeOverLifetime = new SeparatedMinMaxCurve(new AnimationCurve(new[] { new Keyframe(0f, 1f), new Keyframe(1f, 1f) }));
        ...
        [SerializeField]
        SeparatedMinMaxCurve _sizeBySpeed = new SeparatedMinMaxCurve(new AnimationCurve(new[] { new Keyframe(0f, 1f), new Keyframe(1f, 1f) }));
        ...
        [SerializeField]
        SpeedRange _sizeSpeedRange = new SpeedRange(0f, 1f);
        ...
        [SerializeField]
        SeparatedMinMaxCurve _startRotation = new SeparatedMinMaxCurve(0f);
        ...
        [SerializeField]
        SeparatedMinMaxCurve _rotationOverLifetime = new SeparatedMinMaxCurve(0f);
        ...
        [SerializeField]
        SeparatedMinMaxCurve _rotationBySpeed = new SeparatedMinMaxCurve(new AnimationCurve(new[] { new Keyframe(0f, 1f), new Keyframe(1f, 1f) }));
        ...
        [SerializeField]
        SpeedRange _rotationSpeedRange = new SpeedRange(0f, 1f);
        ...
        [SerializeField]
        ParticleSystem.MinMaxCurve _speedOverLifetime = new ParticleSystem.MinMaxCurve(1f);
        ...
        [SerializeField]
        ParticleSystem.MinMaxCurve _gravity = new ParticleSystem.MinMaxCurve(-9.81f);
        ...
        [SerializeField]
        Module _targetModule = new Module(false);
        ...
        [SerializeField]
        ParticleSystem.MinMaxCurve _toTarget = new ParticleSystem.MinMaxCurve(1f, new AnimationCurve(new[] { new Keyframe(0f, 0f), new Keyframe(1f, 1f) }));
        ...
        [SerializeField]
        AttractorType _targetMode = AttractorType.Pivot;
        ...
        [SerializeField]
        Module _noiseModule = new Module(false);
        ...
        [SerializeField]
        Module _gravityModule = new Module(false);
        ...
        [SerializeField]
        Module _vortexModule = new Module(false);
        ...
        [SerializeField]
        Module _velocityModule = new Module(false);
        ...
        [SerializeField]
        SeparatedMinMaxCurve _velocityOverLifetime = new SeparatedMinMaxCurve(0f, true, false);
        ...
        [SerializeField]
        ParticleSystem.MinMaxCurve _vortexStrength;
        ...
        [SerializeField]
        Module _sheetModule = new Module(false);
        ...
        [SerializeField]
        Vector2Int _textureTile = Vector2Int.one;
        ...
        [SerializeField]
        SheetType _sheetType = SheetType.FPS;
        ...
        [SerializeField]
        ParticleSystem.MinMaxCurve _frameOverTime;
        ...
        [SerializeField]
        ParticleSystem.MinMaxCurve _startFrame = new ParticleSystem.MinMaxCurve(0f);
        ...
        [SerializeField]
        SpeedRange _frameSpeedRange = new SpeedRange(0f, 1f);
        ...
        List<Particle> _particles = new List<Particle>(128);
...
#if PARTICLE_IMAGE_JOBS
        NativeList<ParticleData> jobParticles;
        ...
        NativeList<FixedList4096Bytes<TrailPointData>> trailData;
        ...
        ParticleJob _particleJob;
        JobHandle _particleJobHandle;

        TrailJob _trailJob;
        JobHandle _trailJobHandle;

        Vector3 _lastTransformPosition;
        Quaternion _lastTransformRotation;
        Vector3 _transformDeltaRotation;
#endif
        ...
        [SerializeField]
        List<Burst> _bursts = new List<Burst>();

        [FormerlySerializedAs("_trailRenderer")]
        [SerializeField]
        ParticleTrailRenderer _particleTrailRenderer;
        ...
        [SerializeField] Module _trailModule;
        ...
        [SerializeField] ParticleSystem.MinMaxCurve _trailWidth = new ParticleSystem.MinMaxCurve(1f, new AnimationCurve(new[] { new Keyframe(0f, 1f), new Keyframe(1f, 0f) }));
        ...
        [SerializeField] float _trailLifetime = 1f;
        ...
        [SerializeField] float _minimumVertexDistance = 10f;
        ...
        [SerializeField] ParticleSystem.MinMaxGradient _trailColorOverLifetime = new ParticleSystem.MinMaxGradient(Color.white);
        ...
        [SerializeField] ParticleSystem.MinMaxGradient _trailColorOverTrail = new ParticleSystem.MinMaxGradient(Color.white);
        ...
        [SerializeField] bool _inheritParticleColor;
        ...
        [SerializeField] bool _dieWithParticle = false;
        ...
        [Range(0f, 1f)]
        [SerializeField] float _trailRatio = 1f;
        ...
        Vector2Int _noiseViewSize = new Vector2Int(64, 64);
        ...
        [SerializeField]
        Module _multithreadModule = new Module(false);

        [SerializeField]
        bool _multithreadEnabled = false;
        ...
        [SerializeField]
        UnityEvent _onStart = new UnityEvent();
        ...
        [SerializeField]
        UnityEvent _onFirstParticleFinish = new UnityEvent();
        ...
        [SerializeField]
        UnityEvent _onParticleFinish = new UnityEvent();
        ...
        [SerializeField]
        UnityEvent _onLastParticleFinish = new UnityEvent();
        ...
        [SerializeField]
        UnityEvent _onStop = new UnityEvent();
        ...
        bool _firstParticleFinished;

        int _orderPerSec;
        int _orderOverLife;
        int _orderOverDistance;
        ...
        Vector3 RotatePointAroundCenter(Vector3 point, Vector3 angles)
        {
        ...
        void Simulate(float deltaTime, bool prewarming = false)
        {
            //<Generate Particles>
        ...
        Vector2 GetPointOnRect(float angle, float w, float h)
        {
        ...
        float2 GetPointOnRectFloat2(float angle, float w, float h)
        {
        ...
        ParticleData GenerateJobParticle(int order, int source, Burst burst)
        {
            float angle = 0;
            if (source == 0)//Burst
            {
        ...
        Particle GenerateParticle(int order, int source, Burst burst, float startTime)
        {
            float angle = 0;
            if (source == 0)//Burst
            {
        ...
        Vector3 RotateOnAngle(float angle)
        {
        ...
        Vector3 RotateOnAngle(Vector3 p, float angle)
        {
        ...
        float2 RotateOnAngleFloat2(float angle)
        {
        ...
        float2 RotateOnAngleFloat2(float2 p, float angle)
        {
