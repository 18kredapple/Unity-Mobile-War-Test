...
namespace UiParticles
{
	...
	public class UiParticles : MaskableGraphic
	{
		...
		UiParticleRenderMode m_RenderMode = UiParticleRenderMode.Billboard;
		...
		float m_StretchedSpeedScale = 1f;
		...
		[SerializeField]
		[Tooltip("Speed Scale for streched billboards")]
		float m_StretchedLenghScale = 1f;
		...
		void DrawParticleBillboard(ParticleSystem.Particle particle, VertexHelper vh)
		{
		...
		void EvaluateQuadUVs(Vector2[] uvs)
		{
		...
		/// <param name="uvs"></param>
		void EvaluateTexturesheetUVs(ParticleSystem.Particle particle, float timeAlive, Vector2[] uvs)
		{
		...
		void GetStrechedBillboardsSizeAndRotation(ParticleSystem.Particle particle, float timeAlive01,
